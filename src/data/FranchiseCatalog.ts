...
const FRANCHISE_TEMPLATES: FranchiseTemplate[] = [
  ...
  },
  {
    ...
    genre: ['sci-fi', 'horror'],
    tone: 'dark',
    parodySource: 'Voidborne',
    inspirationLabel: 'Alien',
    originMedium: 'film',
  ...
  // Fantasy
  {
    ...
    inspirationLabel: 'The Lord of the Rings',
    originMedium: 'novel',
  ...
  // Superhero
  {
    ...
    inspirationLabel: 'Marvel Cinematic Universe',
    originMedium: 'comic',
  ...
  // Horror
  {
    ...
    inspirationLabel: 'A Nightmare on Elm Street',
    originMedium: 'film',
  ...
  },
  {
    ...
    inspirationLabel: 'Mission: Impossible',
    originMedium: 'film',
  ...
  // Crime
  {
    ...
    inspirationLabel: 'The Godfather',
    originMedium: 'film',
  ...
  // Adventure
  {
    ...
    inspirationLabel: 'Jurassic Park',
    originMedium: 'novel',
  ...
  },
  {
    ...
    inspirationLabel: 'Pirates of the Caribbean',
    originMedium: 'film',
  ...
  // Sci-Fi / Action
  {
    ...
    inspirationLabel: 'The Terminator',
    originMedium: 'film',
  ...
  {
    titlePatterns: ['Drop Troopers', 'Bug War', 'Star Infantry', 'Offworld Draft'],
    genre: ['sci-fi', 'action'],
    tone: 'dark',
    parodySource: 'Star Infantry',
    inspirationLabel: 'Starship Troopers',
    originMedium: 'novel',
  ...
  {
    titlePatterns: ['Chrome Nomads', 'Wasteland Road', 'Dust Kingdom', 'Road of Fury'],
    genre: ['action', 'thriller'],
    tone: 'dark',
    parodySource: 'Wasteland Road',
    inspirationLabel: 'Mad Max',
    originMedium: 'film',
  ...
  {
    titlePatterns: ['Dead March', 'Dead Weekend', 'Outbreak City', 'Last Shelter'],
    genre: ['horror', 'thriller'],
    tone: 'dark',
    parodySource: 'Zombie Day',
    inspirationLabel: 'The Walking Dead',
    originMedium: 'tv',
  ...
  // Thriller / Crime
  {
    ...
    inspirationLabel: "Ocean's Eleven",
    originMedium: 'film',
  ...
  },
  {
    ...
    inspirationLabel: 'Sherlock Holmes',
    originMedium: 'novel',
  ...
  },
  {
    ...
    inspirationLabel: 'The Hunger Games',
    originMedium: 'novel',
  ...
  // Fantasy / YA
  {
    ...
    inspirationLabel: 'Percy Jackson',
    originMedium: 'novel',
  ...
  // New ideas (games / books)
  {
    ...
    tone: 'serious',
    parodySource: 'Neon Canopy',
    inspirationLabel: 'Watch Dogs',
    originMedium: 'game',
  ...
  },
  {
    ...
    genre: ['sci-fi', 'thriller'],
    tone: 'serious',
    parodySource: 'Revelation Horizon',
    inspirationLabel: 'Revelation Space',
    originMedium: 'novel',
  ...
  },
  {
    ...
    genre: ['crime', 'drama'],
    tone: 'serious',
    parodySource: 'Omerta City',
    inspirationLabel: 'Mafia',
    originMedium: 'game',
  ...
  },
  {
    ...
    genre: ['sci-fi', 'horror'],
    tone: 'dark',
    parodySource: 'Callisto Blacksite',
    inspirationLabel: 'The Callisto Protocol',
    originMedium: 'game',
  ...
  },
  {
    ...
    genre: ['adventure', 'sci-fi'],
    tone: 'serious',
    parodySource: 'Jade Signal',
    inspirationLabel: 'Beyond Good & Evil',
    originMedium: 'game',
  ...
  // More games
  {
    titlePatterns: ['Augment Covenant', 'Ghost in the Grid', 'The Black Budget', 'Human Upgrade'],
    genre: ['sci-fi', 'thriller'],
    tone: 'serious',
    parodySource: 'Augment Covenant',
    inspirationLabel: 'Deus Ex',
    originMedium: 'game',
    tags: ['conspiracy', 'augmentation', 'corporations', 'espionage'],
    culturalWeight: 73,
    description:
      'A near-future conspiracy thriller where body modification is power and every organization has a second agenda. Fans expect layered plots, morally gray choices, and a world that feels plausible enough to be unsettling.',
  },
  {
    titlePatterns: ['Relay Vanguard', 'Citadel Meridian', 'The Reaper War', 'Spectral Armada'],
    genre: ['sci-fi', 'adventure'],
    tone: 'epic',
    parodySource: 'Relay Vanguard',
    inspirationLabel: 'Mass Effect',
    originMedium: 'game',
    tags: ['space opera', 'alien diplomacy', 'squad', 'ancient threat'],
    culturalWeight: 81,
    description:
      'A space-opera adventure built around squad bonds, big moral calls, and an ancient enemy that makes politics feel small. It thrives on characters you’d follow anywhere and missions that feel like chapters in a personal epic.',
  },
  {
    titlePatterns: ['Rapture Depths', 'Atlas of Ruin', 'The Sea Below', 'City Under Glass'],
    genre: ['sci-fi', 'thriller'],
    tone: 'dark',
    parodySource: 'Rapture Depths',
    inspirationLabel: 'BioShock',
    originMedium: 'game',
    tags: ['underwater city', 'ideology', 'mutations', 'retro-future'],
    culturalWeight: 76,
    description:
      'A retro-futurist thriller in a failed utopia where ideology collapses into violence. The appeal is atmosphere: decaying grandeur, philosophical conflict, and horror that comes from human ambition.',
  },
  {
    titlePatterns: ['Phantom Operative', 'Shadow Nuclear', 'The Patriot File', 'Snake Oil'],
    genre: ['action', 'thriller'],
    tone: 'serious',
    parodySource: 'Phantom Operative',
    inspirationLabel: 'Metal Gear Solid',
    originMedium: 'game',
    tags: ['espionage', 'stealth', 'military', 'plot twists'],
    culturalWeight: 74,
    description:
      'A military-espionage thriller where stealth, betrayal, and global politics collide with surreal set pieces. Fans want dense intrigue, memorable bosses, and a protagonist who’s constantly being used by bigger systems.',
  },
  {
    titlePatterns: ['Resonance Rift', 'Black Mesa Incident', 'The Freeman Event', 'Cascade Protocol'],
    genre: ['sci-fi', 'thriller'],
    tone: 'serious',
    parodySource: 'Resonance Rift',
    inspirationLabel: 'Half-Life',
    originMedium: 'game',
    tags: ['science accident', 'alien invasion', 'survival', 'resistance'],
    culturalWeight: 77,
    description:
      'A grounded sci-fi thriller kicked off by a lab disaster that cracks reality open. The hook is momentum and dread: improvised survival, mysterious invaders, and a resistance forming in real time.',
  },
  {
    titlePatterns: ['Whalebone Empire', 'The Dishonored Crown', 'Clockwork Plague', 'Knife & Shadow'],
    genre: ['fantasy', 'thriller'],
    tone: 'dark',
    parodySource: 'Whalebone Empire',
    inspirationLabel: 'Dishonored',
    originMedium: 'game',
    tags: ['assassins', 'plague city', 'steampunk', 'revenge'],
    culturalWeight: 71,
    description:
      'A dark revenge fantasy in a plague-ridden empire where supernatural gifts make every assassination feel like a puzzle. The audience expects moody cities, sharp politics, and stylish violence with consequences.',
  },
  {
    titlePatterns: ['Unseen Bureau', 'The Oldest House', 'Threshold Control', 'Altered Items'],
    genre: ['sci-fi', 'horror'],
    tone: 'serious',
    parodySource: 'Unseen Bureau',
    inspirationLabel: 'Control',
    originMedium: 'game',
    tags: ['paranormal', 'government bureau', 'haunted building', 'reality shifts'],
    culturalWeight: 69,
    description:
      'A paranormal thriller about a secret bureau trying to contain reality-bending events inside a building that rewrites itself. Fans want weird rules, confident mystery, and action that feels like controlled chaos.',
  },
  {
    titlePatterns: ['Umbra Mansion', 'Viral Outbreak', 'Raccoon City', 'Biohazard Night'],
    genre: ['horror', 'thriller'],
    tone: 'dark',
    parodySource: 'Umbra Mansion',
    inspirationLabel: 'Resident Evil',
    originMedium: 'game',
    tags: ['zombies', 'bioweapons', 'corporation', 'survival horror'],
    culturalWeight: 78,
    description:
      'A survival-horror franchise built around corporate bioweapons, escalating outbreaks, and protagonists who refuse to stay down. The brand works when the horror is tactile and the conspiracies feel endless.',
  },

  // More comics (not just superheroes)
  {
    titlePatterns: ['Mega-City Justice', 'Street Judge', 'Law of Tomorrow', 'The Cursed Badge'],
    genre: ['sci-fi', 'crime'],
    tone: 'dark',
    parodySource: 'Mega-City Justice',
    inspirationLabel: 'Judge Dredd',
    originMedium: 'comic',
    tags: ['dystopia', 'law enforcement', 'satire', 'mega city'],
    culturalWeight: 68,
    description:
      'A satirical dystopian crime saga where street judges are judge, jury, and executioner. Fans want hard-edged action, dark comedy, and a city that feels like it’s collapsing under its own rules.',
  },
  {
    titlePatterns: ['Endless Dream', 'The Sand Kingdom', 'Waking Myths', 'The Pale Theatre'],
    genre: ['fantasy', 'drama'],
    tone: 'serious',
    parodySource: 'Endless Dream',
    inspirationLabel: 'The Sandman',
    originMedium: 'comic',
    tags: ['mythology', 'dreams', 'anthology', 'gothic'],
    culturalWeight: 72,
    description:
      'A mythic, gothic fantasy that treats stories as living things. The appeal is mood and ideas—dream logic, folklore, and episodes that can be intimate one moment and cosmic the next.',
  },
  {
    titlePatterns: ['Starbound Kin', 'War & Family', 'Horned Worlds', 'Paper Moons'],
    genre: ['sci-fi', 'adventure'],
    tone: 'epic',
    parodySource: 'Starbound Kin',
    inspirationLabel: 'Saga',
    originMedium: 'comic',
    tags: ['space opera', 'family', 'war', 'odd creatures'],
    culturalWeight: 70,
    description:
      'A sweeping space-opera about two people from opposing sides trying to build a family while the galaxy hunts them. Fans expect wild creature design, bold emotion, and comedy that doesn’t undercut the stakes.',
  },
  {
    titlePatterns: ['Keyhouse Chronicles', 'The Black Keys', 'Doors Within', 'The Lock & Bone'],
    genre: ['horror', 'mystery'],
    tone: 'dark',
    parodySource: 'Keyhouse Chronicles',
    inspirationLabel: 'Locke & Key',
    originMedium: 'comic',
    tags: ['haunted house', 'magic keys', 'family trauma', 'secrets'],
    culturalWeight: 66,
    description:
      'A haunted-house mystery where magical keys unlock powers—and consequences. The franchise works when it balances wonder with grief and treats every new “key” as a tempting mistake.',
  },
  {
    titlePatterns: ['Noir Basin', 'City of Sin', 'Hard Rain', 'Neon Blood'],
    genre: ['crime', 'drama'],
    tone: 'dark',
    parodySource: 'Noir Basin',
    inspirationLabel: 'Sin City',
    originMedium: 'comic',
    tags: ['noir', 'anthology', 'corruption', 'stylized violence'],
    culturalWeight: 64,
    description:
      'A stylized noir crime anthology set in a city where everyone is compromised. The hook is voiceover-heavy grit, larger-than-life criminals, and moral choices that always leave a stain.',
  },
  {
    titlePatterns: ['Valley of Bones', 'The Thorny Kingdom', 'Cousins of the Forest', 'Crown of Dust'],
    genre: ['fantasy', 'adventure'],
    tone: 'light',
    parodySource: 'Valley of Bones',
    inspirationLabel: 'Bone',
    originMedium: 'comic',
    tags: ['classic quest', 'family-friendly', 'mystery', 'whimsy'],
    culturalWeight: 62,
    description:
      'A warm, adventurous quest with a cartoony surface and a surprisingly epic heart. Fans want charm, weird creatures, and a story that grows in scope without losing its friendliness.',
  },
];
