...
export class TimeSystem {
  static advanceWeek(timeState: TimeState): TimeState {
    ...
    console.log(
      `TIME ADVANCE: Week ${timeState.currentWeek} Year ${timeState.currentYear} -> Week ${newWeek} Year ${newYear}`
    );
  ...
  static calculateWeeksSince(
    ...
    console.log(
      `WEEKS CALC: Y${releaseYear}W${releaseWeek} to Y${currentYear}W${currentWeek} = ${weeksSince} weeks`
    );
